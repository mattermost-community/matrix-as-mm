...
const config: PlaywrightTestConfig<userAuthProfile.UserAuthConfig> = {
    ...
    use: {
        ...
        matrix_connector: {
            user: '<none>',
            baseURL:
                'http://ec2-54-216-207-175.eu-west-1.compute.amazonaws.com:9995',
            bearerToken:
        ...
        mattermost_admin: {
            ...
            baseURL:
                'http://ec2-54-216-207-175.eu-west-1.compute.amazonaws.com',
            domain: 'localhost',
        ...
        matrix_admin: {
            ...
            baseURL:
                'http://ec2-54-216-207-175.eu-west-1.compute.amazonaws.com:8008',
            domain: 'localhost',
            bearerToken: 'syt_YWRtaW4_bihzjNVTSABtwCbmgAJD_3pqKAm',
        },
        matrix_user1: {
            user: 'user1.matrix',
            password: 'User..1234',
