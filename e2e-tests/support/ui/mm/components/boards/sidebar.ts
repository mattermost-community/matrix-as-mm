...
export default class BoardsSidebar {
    ...
    constructor(container: Locator) {
        ...
        this.createNewBoardMenuItem = container.getByRole('button', {
            name: 'Create new board',
        });
        this.createNewCategoryMenuItem = container.getByRole('button', {
            name: 'Create New Category',
        });
        this.titles = container.locator(
            '.SidebarBoardItem > .octo-sidebar-title',
        );
    }
